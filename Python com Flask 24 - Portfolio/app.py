    ...
    if not os.path.exists(DATA_FILE):
        ...
        initial_data = {
            "perfil": {
                ...
                "bio": "Desenvolvedor full stack, focado em Python, Java, C#, projetos SQL, NoSQL e projetos web.",
                "redes_sociais": [
                    {"nome": "GitHub", "url": "#"},
                ]
            },
            "habilidades": ["Python", "C/C++", "Java", "Flask", "Django", "Node.js", "Express.js", "Jquery", "SQL",
